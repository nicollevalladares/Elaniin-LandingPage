    ...
    <div>
        <nav class="navbar p-0 header navbar-expand-lg navbar-light">
            <router-link class="d-lg-none navbar-brand" to="/">
                <span class="nav-link p-0 foodies-link">Foodies</span>
            </router-link>
            ...
            <div class="collapse navbar-collapse" id="headerCollapse">
                ...
                <div class="navbar-nav">
                    <router-link class="nav-item" to="/">
                        <span class="header-link nav-link">Acerca De</span>
                    </router-link>
                    <router-link class="nav-item" to="/">
                        <span class="header-link nav-link">Restaurantes</span>
                    </router-link>
                    <router-link class="nav-item" to="/menu">
                        <span class="header-link nav-link">Menú</span>
                    </router-link>
                    <router-link class="nav-item" to="/">
                        <span class="header-link nav-link">Contáctanos</span>
                    </router-link>
                </div>
            </div>
        </nav>
