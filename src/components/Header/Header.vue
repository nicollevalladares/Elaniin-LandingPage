<template>
    <nav class="navbar navbar-expand-lg navbar-light pt-5 pt-lg-5 pt-md-30 pt-sm-5 pl-lg-6 pl-md-40 position-absolute w-100">
        ...
        <button
            ...
            <span class="icon-bar top-bar" v-bind:style="{ background: headerColor }"></span>
            <span class="icon-bar middle-bar" v-bind:style="{ background: headerColor }"></span>
            <span class="icon-bar bottom-bar" v-bind:style="{ background: headerColor }"></span>
            <span class="sr-only">Toggle navigation</span>
        </button>
        <div class="collapse navbar-collapse" id="headerCollapse" v-bind:style="{ background: headerBackground }">
